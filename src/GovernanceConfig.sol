...
contract GovernanceConfig is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    /// @notice One-time init: assigns `DEFAULT_ADMIN_ROLE`, default caps/TTL from PRD, and default approval policies per `RequestType`.
